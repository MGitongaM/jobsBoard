    ...
    <section className="bg-amber-50 px-2 py-10">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {featuredCompanies.map((comapny) => (
            <div
              key={comapny.companyName}
              className="grid place-content-center space-y-10 p-2 rounded-md bg-jobsBg  shadow-md"
            >
              ...
              <div className="flex gap-10">
                <div className="flex gap-1">
                  ...
                  <p className="text-base text-gray-400">
                    {comapny.comapnyIndustry}
                  </p>
                </div>
                <div className="flex gap-1">
                  <CalendarDays size={20} />
                  <p className="text-base text-gray-400">
                    {comapny.comapnyFouding}
                  </p>
                </div>
              </div>
              <hr />
              <div className="flex gap-1">
                <Users size={20} />
                <p className="text-base text-gray-400">
                  {comapny.companyCount} employees
                </p>
              </div>
            </div>
          ))}
